...
from src.calculator.wastage import calculate_wastage
...
class TestWastage(unittest.TestCase):
    ...
    def test_calculate_wastage_should_return_zero_when_no_wastage(self):
        ...
        wastage = calculate_wastage(completed_tickets, discarded_tickets)
    ...
    def test_calculate_wastage_should_raise_error_when_no_completed_tickets(self):
        discarded_tickets = []
        completed_tickets = []
        self.assertRaises(ValueError, calculate_wastage, completed_tickets, discarded_tickets)
